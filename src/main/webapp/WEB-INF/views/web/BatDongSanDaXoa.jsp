...
<div class="row" style="width: 100%;">
	<div class="col-lg-12">
		<div class="main-card mb-12 card">
			<div class="card-body">
				<h5 class="card-title">Bất động sản đã xóa</h5>
								...
								<li class="list-group-item-action list-group-item">
									<div class="single-profile-front row">
										...
										<div class="profile-img col-lg-2"
											...
											<button class="mb-2 mr-2 btn btn-primary btn-BDSBX-khoiphuc"
...
<script src="/js/trangcanhan/batdongsanbixoa.js"></script>
