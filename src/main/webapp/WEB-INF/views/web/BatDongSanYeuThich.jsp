								...
								<li class="list-group-item-action list-group-item">
									<div class="single-profile-front row">
										...
										<div class="profile-img col-lg-2"
											...
											<i id-baidang="${bds.id}" data-toggle="tooltip"
												title="Xóa khỏi danh sách yêu thích"
												class="btn-BDSYT-delete metismenu-icon pe-7s-trash font-icon-wrapper btn-outline-danger btn-icon-only btn-icon"></i>
