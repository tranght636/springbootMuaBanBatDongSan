...
<div class="row">
	<div class="col-lg-12">
	    <div class="main-card mb-12 card">
	        <div class="card-body"><h5 class="card-title">Chi tiết bất động sản</h5>
				                    ...
				                    <div class="col-xl-9 col-lg-9 col-md-9">
				                        <div class="h1-testimonial-active">
				                            ...
				                            <div class="single-testimonial pt-65">
				                            	<div class="single-profile-front">
													<div class="profile-img">
														 <img src="/img/web/TpHue.jpg" alt="" style="width: 100%; height: 100%;" >
													</div>
				                            ...
				                            <div class="single-testimonial pt-65">
				                                <div class="single-profile-front">
													<div class="profile-img">
														 <img src="/img/web/TpHCM.jpg" alt="" style="width: 100%; height: 100%;" >
													</div>
													<div class="profile-caption"> </div>
				                            	</div>
				                        	</div>
