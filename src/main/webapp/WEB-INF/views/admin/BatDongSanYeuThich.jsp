...
<div class="row" style="width: 100%;">
	<div class="col-lg-12" >
	    <div class="main-card mb-12 card">
	        <div class="card-body"><h5 class="card-title">hiển thị 100 bds được yêu thích nhiều nhất </h5>
							...
							<li class="list-group-item-action list-group-item" >
								<div class="single-profile-front row" >
									...
									<div class="profile-img col-lg-2" style="text-align: right; font-size: 30px;" >
										<small style="font-size: 13px;float: right;">100 <i class="pe-7s-like" style="color: red;"></i></small>
